...
<form action="operations.php" method="POST">
   ...
   <input type="password" id="password" name="password" value="<?= htmlspecialchars($user['password']) ?>" required><br><br>

   <label for="name">Имя:</label><br>
   <input type="text" id="name" name="name" value="<?= htmlspecialchars($user['name']) ?>" required><br><br>

   <label for="surname">Фамилия:</label><br>
   <input type="text" id="surname" name="surname" value="<?= htmlspecialchars($user['surname']) ?>" required><br><br>

   <label for="gender">Пол:</label><br>
   <input type="radio" name="gender" value="0" <?= $user['gender'] == 0 ? 'checked' : '' ?>> Муж<br>
